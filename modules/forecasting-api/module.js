...
module.exports = function(app) {
    ...
    /* Forecasting Api */
    app.get('/forecasting-api/accounts/:accountId/accountprojection/projected-summary',(req, res) => {

        console.log("get forecasting account projection summary");
        files.sendFile(res, '\\modules\\forecasting-api\\responses\\summary.json');
    });

    app.get('/forecasting-api/accounts/:accountId/accountprojection/detail',(req, res) => {
